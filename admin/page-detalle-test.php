...
<section>
  <div id="form-5" class="ani_step" id="content">
    ...
    <div class="container">
      ...
      <div class="text-left"><strong>NOMBRE:</strong> <span id="name_reg"></span><?php echo $data['nombres'] . " " . $data['apellidos'] //echo $_SESSION['registro']['Apellidos']; 
                                                                                  ?> <?php //echo $_SESSION['registro']['Nombres']; 
                                                                                      ?></div>
      <div class="text-left"><strong>EDAD:</strong> <span id="edad_reg"></span><?php echo $data['edad'] //echo $_SESSION['registro']['Edad']; 
                                                                                ?> Años</div>
      <div class="text-left"><strong>GRADO DE INSTRUCCIÓN:</strong> <span id="grado_reg"></span> <?php echo $data['grado'] // echo $_SESSION['registro']['Grado']; 
                                                                                                  ?> </div>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              ...
              <td class="text-center"><span id="Est_G1"></span><?php echo $data['EstG1']; //echo $_SESSION['registroEstG']['EstG1']; 
                                                                ?></td>
              <td class="text-center"><span id="Est_E1"></span><?php echo $data['EstE1']; //echo $_SESSION['registroEstE']['EstE1']; 
                                                                ?></td>
            </tr>
            <tr>
              <th scope="row" class="text-center">B</th>
              <td class="text-center"><span id="Est_G2"></span><?php echo $data['EstG2']; //echo $_SESSION['registroEstG']['EstG2']; 
                                                                ?></td>
              <td class="text-center"><span id="Est_E2"></span><?php echo $data['EstE2']; //echo $_SESSION['registroEstE']['EstE2']; 
                                                                ?></td>
            </tr>
            <tr>
              <th scope="row" class="text-center">C</th>
              <td class="text-center"><span id="Est_G3"></span><?php echo $data['EstG3']; //echo $_SESSION['registroEstG']['EstG3']; 
                                                                ?></td>
              <td class="text-center"><span id="Est_E3"></span><?php echo $data['EstE3']; //echo $_SESSION['registroEstE']['EstE3']; 
                                                                ?></td>
            </tr>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              <th scope="row" class="text-center">A</th>
              <td class="text-center"><span id="in_E1"></span><?php echo $data['Exito_A']; //echo $NFE1 
                                                              ?></td>
              <td class="text-center"><span id="in_F1"></span><?php echo $data['Fracaso_A']; //echo $NFF1 
                                                              ?></td>
            </tr>
            <tr>
              <th scope="row" class="text-center">B</th>
              <td class="text-center"><span id="in_E2"></span><?php echo $data['Exito_B']; //echo $NFE2 
                                                              ?></td>
              <td class="text-center"><span id="in_F2"></span><?php echo $data['Fracaso_B']; //echo $NFF2 
                                                              ?></td>
            </tr>
            <tr>
              <th scope="row" class="text-center">C</th>
              <td class="text-center"><span id="in_E3"></span><?php echo $data['Exito_C'] //echo $NFE3 
                                                              ?></td>
              <td class="text-center"><span id="in_F3"></span><?php echo $data['Fracaso_C']; //echo $NFF3 
                                                              ?></td>
            </tr>
...
<script>
  $('#exportar-test').on('click', function() {
    $("#form-5").wordExport();
  });
</script>